...
pub struct CreateCollectionArgs {
    pub name: String,
    pub uri: String, // uri of the metadata
    pub nft_name: String,
    pub nft_uri: String, // uri of the NFT metadata
}
...
pub struct CreateCollection<'info> {
    ...
    pub collection_authority: Account<'info, CollectionAuthority>, //  a local PDA (collection_authority) that becomes the update/plugin authority for that collection
