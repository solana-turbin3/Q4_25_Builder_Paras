...
const initializeTx = getInitializeInstruction({
    github: "duckaet",
    user: keypair,
    account,
...
const transactionMessageInit = pipe(
    ...
    tx => appendTransactionMessageInstructions([initializeTx], tx)
);
...
// try {
//     const resultSubmit = await sendAndConfirmTransaction(
//         signedTxSubmit,
//         { commitment: 'confirmed', skipPreflight: false }
//     );
